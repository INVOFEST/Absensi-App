...
public class QRTalkshow extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(QRTalkshow.this)
                .setMessage(message)
...
//                .setNegativeButton("Cancel", null)
    ...
    public void handleResult(final Result result) {
        ...
        builder.setTitle("ID Peserta Talkshow");
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Call<BaseResponse<User>> _Talkshow = postEvent.absen_talkshow(result.getText().toString());
                _Talkshow.enqueue(new Callback<BaseResponse<User>>() {
                    @Override
                    public void onResponse(Call<BaseResponse<User>> call, Response<BaseResponse<User>> response) {
                        if (response.isSuccessful()){
                            ...
                            if (body != null && body.getStatus()){
                                users = body.getData();
//                                Intent a = new Intent(QRTalkshow.this, TalkshowActivity.class);
//                                startActivity(a);
                                finish();
                                ...
                                Toast.makeText(QRTalkshow.this, response.body().getMessage(), Toast.LENGTH_LONG).show();
                                finish();
                            }
                        }else {
                    ...
                    public void onFailure(Call<BaseResponse<User>> call, Throwable t) {
                        Toast.makeText(QRTalkshow.this, t.getMessage(), Toast.LENGTH_SHORT).show();
