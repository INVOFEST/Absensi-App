...
public class QRSeminar extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    public void handleResult(final Result result) {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Call<BaseResponse<User>>_Seminar = postEvent.absen_seminar(result.getText().toString());
                _Seminar.enqueue(new Callback<BaseResponse<User>>() {
                    @Override
...
//                                startActivity(a);
                    ...
                    public void onFailure(Call<BaseResponse<User>> call, Throwable t) {
                        Toast.makeText(QRSeminar.this, "Gagal Scan Cuyy", Toast.LENGTH_SHORT).show();
