...
public class SeminarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Seminar Cuy");
    ...
    private void scanLogic() {
        ivScan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent a = new Intent(SeminarActivity.this, QRSeminar.class);
                startActivity(a);
            }
        });
    }
    ...
    private void fetchData() {
        ...
        call.enqueue(new Callback<BaseListResponse<User>>() {
                ...
                if (response.isSuccessful()){
                    ...
                    if (a.getStatus()){
                        if (a.getData().isEmpty()){
                            ...
                            users = a.getData();
                            adapter = new AdapterEvent(SeminarActivity.this, users);
                    ...
                    Toast.makeText(SeminarActivity.this, "Nyaris", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<BaseListResponse<User>> call, Throwable t) {
                Toast.makeText(SeminarActivity.this, "Failure", Toast.LENGTH_SHORT).show();
